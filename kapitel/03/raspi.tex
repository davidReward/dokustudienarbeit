...
\caption{\ac{I2C} im freien Zustand \cite{cc}}
\label{i2c_frei}
\end{figure}
...
\caption{Startbedingung bei \ac{I2C} \cite{cc}}
\label{i2c_start}
\end{figure}
...
\caption{Logische 0 bei \ac{I2C} \cite{cc}}
\label{i2c_0}
\end{figure}
...
\caption{Logische 1 bei \ac{I2C} \cite{cc}}
\label{i2c_1}
\end{figure}
...
\caption{Acknowledgement bei \ac{I2C} \cite{cc}}
\label{i2c_ack}
\end{figure}
...
\caption{No-Acknowledgement bei \ac{I2C} \cite{cc}}
\label{i2c_NoAck}
\end{figure}
...
\caption{SPI-Schema \cite{dembowski2015raspberry}}
\label{spi}
\end{figure}
