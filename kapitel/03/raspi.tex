...
Python ist sowohl eine Programmiersprache als auch der Name des entsprechenden Interpreters. Python ist demzufolge eine interpretierte Programmiersprache. Der Interpreter ist ebenfalls Open Source. Python gilt als leicht erlernbar und flexibel nutzbar. HIER : Eigenschaften von Python (keine klammern etc)


\subsubsection{PyCharm}   
 
%TODO Quelle: handbuch
